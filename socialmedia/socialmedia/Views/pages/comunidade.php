		...
		<div class="feed">
			...
			<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						<?php foreach(\socialmedia\Models\UsuariosModel::listarAmigos() as $key => $value){ ?>
			...
			<br/>
				...
				<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						...
						<?php
							$comunidade = \socialmedia\Models\UsuariosModel::listarComunidade();
						...
						<div class="container-comunidade-single">
							...
							<div class="btn-solicitar-amizade">
								<?php
									if(\socialmedia\Models\UsuariosModel::existePedidoAmizade($value['id'])){
								?>
