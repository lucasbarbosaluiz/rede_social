...
<body>
	...
	<section class="main-feed">
		...
		<?php
			$retrievePosts = \socialmedia\Models\HomeModel::retrieveFriendsPosts();
		...
		<?php } ?>
			...
			<div class="friends-request-feed">
				...
				<?php
					...
					foreach(\socialmedia\Models\UsuariosModel::listarAmizadesPendentes() as $key=>$value){
					$usuarioInfo = \socialmedia\Models\UsuariosModel::getUsuarioById($value['enviou']);
				?>
