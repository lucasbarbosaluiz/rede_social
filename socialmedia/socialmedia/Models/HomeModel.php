	...
	class HomeModel{
		...
		public static function retrieveFriendsPosts(){
			...
			foreach ($amigosConfirmados as $key => $value) {
				$listaAmigos[$key]['id'] = \socialmedia\Models\UsuariosModel::getUsuarioById($value)['id'];
				$listaAmigos[$key]['nome'] = \socialmedia\Models\UsuariosModel::getUsuarioById($value)['nome'];
				$listaAmigos[$key]['email'] = \socialmedia\Models\UsuariosModel::getUsuarioById($value)['email'];
				$listaAmigos[$key]['img'] = \socialmedia\Models\UsuariosModel::getUsuarioById($value)['img'];
				$listaAmigos[$key]['ultimo_post'] = \socialmedia\Models\UsuariosModel::getUsuarioById($value)['ultimo_post'];
			}
